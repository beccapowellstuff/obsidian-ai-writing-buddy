# Styling, theming, and release readiness

Goal: prepare the plugin for real-world Obsidian use.

- REL-003 DONE: Avoid global element selectors.

- REL-001 TODO: Before release, review CSS for Obsidian community plugin readiness.
- REL-002 PARTIAL: Scope all selectors under `.ai-draft-bench` where practical.
- REL-004 PARTIAL: Use Obsidian theme variables instead of hardcoded colours.
...
- REL-007 LATER: Consider future visual themes such as Default, Soft, Minimal, Paper, and High contrast.
- REL-008 LATER: Add visual theme selection later through the settings page.
