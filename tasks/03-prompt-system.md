...
- PB-007 DONE: Build request payloads for general chat.
- PB-008 DONE: Build request payloads for selected-text requests.
- PB-009 DONE: Build request payloads for follow-up replies.
...
- OCP-002 DONE: Add reset-to-default button.
- OCP-003 DONE: Use open chat system prompt for general chat entries.
- OCP-004 DONE: Keep open chat prompt separate from selected-text templates.
...
- STP-003 DONE: Use selected text as explicit source context.
- STP-004 DONE: Make sure the AI understands it must respond to the selected text, not overwrite it automatically.
- STP-005 DONE: Add clear instruction formatting for selected-text requests.
- STP-006 DONE: Keep selected text, user instruction, and template prompt separate in the request model.

## Personality prompt

- PER-001 DONE: Add personality prompt setting.
- PER-002 DONE: Add personality enabled toggle.
- PER-003 DONE: Apply personality prompt to open chat and drafting requests when enabled.
- PER-005 DONE: Make personality prompt clearly separate from task templates.
- PER-006 TODO: Add selectable personality templates/presets.
